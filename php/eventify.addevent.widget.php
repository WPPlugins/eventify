	...
	function eventifyaddeventwidget()
	{
					...
					if($repeats_event=="yes"){ $repeats_type=$_POST['em_repeats_type']; $repeats_until=$_POST['em_repeats_until'];}else {$repeats_type='0'; $repeats_until='0';}
						$table_name = $wpdb->prefix."em_main";
							...
							// Insert the post into the database
								...
								$sql = "insert into ".$table_name." values(null,'".$_POST['datepicker']."','".$_POST['timepick_from']."-".$_POST['timepick_to']."','".str_ireplace("'","\'",$_POST['em_desc'])."','".str_ireplace("'","\'",$_POST['em_title'])."','".str_ireplace("'","\'",$_POST['em_venue'])."','".$_POST['em_timezone']."','".$postedid."','".strtotime($_POST['datepicker'])."','".$repeats_evet."','".$repeats_type."','".$repeats_until."')";

						 	}
						 	else
						 	{
						 		$sql = "insert into ".$table_name." values(null,'".$_POST['datepicker']."','".$_POST['timepick_from']."-".$_POST['timepick_to']."','".str_ireplace("'","\'",$_POST['em_desc'])."','".str_ireplace("'","\'",$_POST['em_title'])."','".str_ireplace("'","\'",$_POST['em_venue'])."','".$_POST['em_timezone']."','0','".strtotime($_POST['datepicker'])."','".$repeats_evet."','".$repeats_type."','".$repeats_until."')";
						 	}
						 	$wpdb->query($sql);
		...
		<script type="text/javascript">
			jQuery(function() {
                ...
                var picker_repeats2 = new Pikaday({
		...
		<form action="" method="post" id="fronteventifyform">
			...
			<div class="row">  
				...
				<div class="right"><input type="text" size="18" class="datepicker" id="datepicker" name="datepicker" READONLY class="required"></div>
			</div>
