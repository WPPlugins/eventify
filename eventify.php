...
/*
	...
	Plugin URI: http://eventify.zendesk.com/
Description: Thank you for installing the Eventify&trade; WordPress plugin. <br> Eventify&trade; is a plugin to store and show upcoming events in wordpress widgets/sidebar and/or create an event post/page, show a event based list on post/page or/and show a google style calendar with your events on a post/page. It can do much more for your events. For more information please visit the <a href="http://eventify.zendesk.com" target="_blank">help desk</a>. Note: If you uninstall/delete/upgrade the plugin the events scheduled will be lost! More info about <a href="http://eventify.zendesk.com"  target="_blank">Eventify&trade;</a>. <a href="http://www.eventifypro.com" target="_blank">Subscribe</a>, to get an invite for the private beta. Social: <a href="http://www.facebook.com/eventifypro" target="_blank">Facebook</a> | <a href="http://twitter.com//eventifypro" target="_blank">Twitter</a> | <a href="mailto:support@eventify.zendesk.com" target="_blank">Email</a>
Version: 2.0a
	Author: Sojourner.co
	Author URI: http://Sojourner.co
	Text domain: eventify
*/

/*  Copyright 2014  Manoj Sachwani  (email : sojourner.co+eventify@gmail.com)
